...
! mwPointer stuff for mexing
	  ...
	  mwPointer Nhh_pr,Nkk_pr,hhout_pr,kkout_pr
      mwPointer m, n
...
! fortran subroutine arguments
      real*8,allocatable,dimension(:,:) :: Matrix_P0, Matrix_L, EV_r, EV_ind_r, VP_r
...
! call the computational subroutine.
      ...
      deallocate(EV,EV_ind,Matrix_P0,n_EV,hhout,kkout)
