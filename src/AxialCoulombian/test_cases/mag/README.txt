...
File "data_mag.mat" is now created and you can select "new_user_dir" in "MAIN_dense.m" to select the user test case
-------------------------------------------------------------------------------------------------------

Subdirectories contain some examples of data generation:

"test1": geometrical data are taken from a COMSOL mesh file
